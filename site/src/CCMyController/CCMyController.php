    ...
    */
    class CFormMyGuestbook extends CForm {
      ...
      public function __construct($object) {
        parent::__construct();
        $this->object = $object;
        $this->AddElement(new CFormElementTextarea('message', array('label'=>'Add entry:')))
             ->AddElement(new CFormElementText('author', array('label'=>'Author')))
             ->AddElement(new CFormElementText('password', array('label'=>'What is 20 - 6?')))
      ...
      public function DoAdd($form, $object) {
        if(isset($form['password']) && $form['password']['value'] == '13') {
          $author = htmlEnt($form['author']['value']);
          $message = htmlEnt($form['message']['value']);
          return $object->Add($message, $author);
        }
      }
