...
<tbody>
<tr><td>Part of Ridcully Core modules</td><td><?=$module['isRidcullyCore']?'Yes':'No'?></td></tr>
<tr><td>Part of Ridcully CMF modules</td><td><?=$module['isRidcullyCMF']?'Yes':'No'?></td></tr>
